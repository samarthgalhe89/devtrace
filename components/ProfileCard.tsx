...
import { FolderGit2, Users, UserCheck, MapPin, Building2, CalendarDays } from "lucide-react";
    ...
    <div className="glass-card p-6 lg:p-8 animate-fade-in w-full">
      <div className="flex flex-col lg:flex-row items-center lg:items-center justify-between gap-8">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-center gap-6 flex-1 text-center sm:text-left">
          ...
          >
            <div className="w-24 h-24 lg:w-28 lg:h-28 rounded-full overflow-hidden ring-2 ring-border ring-offset-2 ring-offset-background transition-all group-hover:ring-accent">
              <Image
                src={user.avatar_url}
